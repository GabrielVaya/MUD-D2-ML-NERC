...
python3 extract-features.py $BASEDIR/MUD-D2/data/test/ > $BASEDIR/MUD-D2/test.feat $BASEDIR/MUD-D2/resources/DrugBank.txt $BASEDIR/MUD-D2/resources/HSDB.txt 
...
python3 predict.py $BASEDIR/model.crf < $BASEDIR/MUD-D2/test.feat > $BASEDIR/MUD-D2/test-CRF.out
...
python3 evaluator.py NER $BASEDIR/MUD-D2/data/test test-CRF.out > $BASEDIR/MUD-D2/test-CRF.stats
